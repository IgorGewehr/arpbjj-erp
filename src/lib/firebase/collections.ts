...
export const collections = {
  ...
  competitionPhotos: (academyId: string) => getCollection(academyId, 'competitionPhotos'),
  ...
  competitionPhoto: (academyId: string, photoId: string) => getDocRef(academyId, 'competitionPhotos', photoId),
